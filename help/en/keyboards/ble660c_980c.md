...
The charging indicator is a red(or blue) led below the power button(if hardware version is more than v2.5, it is a blue led). You can see it from the bottom. It has three states:
