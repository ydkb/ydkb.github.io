...
> - On macOS, <u>short-pressing <kbd>Capslock</kbd> to switch between Chinese/English and long-pressing to toggle case</u> has compatibility issues with NKRO. If you use this setting, switch to 6KRO.
